...
// IDirect3DPixelShader9* dx_compile_shader(IDirect3DDevice9* device, const std::string &shader_string) noexcept
// {
...
//     auto* pD3DCompile = reinterpret_cast<decltype(D3DCompile)*>(GetProcAddress(module, "D3DCompile"));
